    ...
    function Plugin($container, options)
    {
        ...
        function wheel(event)
        {
            if(self.contentRatio < 1)
            {
                ...
                ,   delta           = wheelEvent === 'wheel' ?
                                        (isHorizontal && Math.abs(eventObject.deltaX) > Math.abs(eventObject.deltaY)) ?
                                            eventObject.deltaX : eventObject.deltaY :
                                        wheelEvent === 'mousewheel' ?
                                            - 1 / 3 * eventObject.wheelDelta : eventObject.detail
                ,   wheelSpeedDelta = - deltaY / 40
                ;
