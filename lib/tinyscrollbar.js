;(function(window, undefined)
{
    ...
    ,   defaults   =
        ...
        ,   resizePosition  : "relative"    // Thumb position for the resize event
        }
    ;

    function Plugin($container, options, document)
    {
        ...
        function setEvents()
        {
            ...
            {
                self.update(self.options.resizePosition);
            }, true);
    ...
    var tinyscrollbar = function($container, options, document)
    {
        return new Plugin($container, options, document);
    };
