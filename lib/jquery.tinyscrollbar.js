...
(function ($)
{
    ...
    ,   defaults   =
        ...
        ,   wheel: true          // Enable or disable the mouse wheel;
        ,   wheelSpeed: 40       // How many pixels must the mouse wheel scroll at a time.
        ,   wheelLock: true      // Lock default scrolling window when there is no more content.
        ,   scrollInvert: false  // Enable invert style scrolling
        ,   trackSize: false     // Set the size of the scrollbar to auto or a fixed number.
        ,   thumbSize: false     // Set the size of the thumb to auto or a fixed number.

        ,   prefix: 'ui-'        // wrapper CSS class prefix, renders "ui-scrollbar" by default.
    ...
    function Plugin($container, options)
    {
        ...
        {
            if (!$container.children(".scrollbar").length) {
                ...
                $container
                    ...
                    .prepend('<div class="scrollbar disable"><div class="track"><div class="thumb"><div class="end"></div></div></div></div>');
            }
